...
// namespace Api;
//
// public class DictionaryConnectionManager : IConnectionManager<IWebSocketConnection>
// {
...
//     }
//
//     public async Task BroadcastToTopic<TMessage>(string topic, TMessage message)
//     {
//         if (!TopicMembers.TryGetValue(topic, out var members))
//         {
